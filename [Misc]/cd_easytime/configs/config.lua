...
Config.Framework = 'other' ---[ 'esx' / 'qbcore' / 'vrp' / 'aceperms' / 'identifiers', 'other' ] Choose your framework (by framework we mean choose the permission system you want to use).
...
Config.FrameworkTriggers = { --You can change the esx/qbcore events (IF NEEDED).
    ...
    load = 'LegacyCore:PlayerLoaded',      --ESX = 'esx:playerLoaded'      QBCORE = 'QBCore:Client:OnPlayerLoaded'
    job = '',             --ESX = 'esx:setJob'            QBCORE = 'QBCore:Client:OnJobUpdate'
    resource_name = 'LEGACYCORE'   --ESX = 'es_extended'           QBCORE = 'qb-core'
}
