lib.addCommand(Config.Command.CreateVehicle, {
    ...
    if GroupData[PlayerGroup] then
        ...
        NOTIFY:SendServerNotification(source, LANG.CoreLang('NoPermission_Notification_Title'),
...
lib.addCommand(Config.Command.SkinPlayer, {
    ...
    if not targetPlayer then
        return NOTIFY:SendServerNotification(source, LANG.CoreLang('NoID_Notification_Title'),
