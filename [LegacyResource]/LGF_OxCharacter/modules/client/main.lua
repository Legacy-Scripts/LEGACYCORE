...
RegisterNetEvent('skinn', function()
    exports['fivem-appearance']:startPlayerCustomization(function(appearance)
        if appearance then
            TriggerServerEvent('SendServerAppearance', appearance)
        else
        end
    end)
end)
...
RegisterNetEvent('LGF_OxCharacter:StartCustomizationCharacter',
    function(CharacterName, CharacterHeigt, CharacterDob, CharacterSex, identifier)
        ...
        exports['fivem-appearance']:startPlayerCustomization(function(appearance)
            if (appearance) then
                TriggerServerEvent('LGF_OxCharacter:QUERY:CreateCharId', cache.serverId, CharacterSex, CharacterHeigt,
